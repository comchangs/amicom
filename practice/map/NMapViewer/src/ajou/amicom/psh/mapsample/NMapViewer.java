...
package ajou.amicom.psh.mapsample;
...
public class NMapViewer extends NMapActivity {
	...
	private static final String API_KEY = "17fa4f7644aca62dca41a5b0e4c2e3a6";
	...
	private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
		...
		public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
			...
			int markerId = NMapPOIflagType.PIN;
			poiData.beginPOIdata(2);
			poiData.addPOIitem(127.0453329, 37.2824052, "광교관ㅋ", markerId, 0);
			poiData.addPOIitem(127.0460609, 37.2832842, "신학생회관", markerId, 0);
			poiData.endPOIdata();
			NMapPOIdataOverlay poiDataOverlay = mOverlayManager.createPOIdataOverlay(poiData,null);
poiDataOverlay.showAllPOIdata(0);

			if (errorInfo == null) {/**mMapController.setMapCenter(mMapLocationManager);**/
				startMyLocation();
				mMyLocationOverlay.setCompassHeadingVisible(true);
