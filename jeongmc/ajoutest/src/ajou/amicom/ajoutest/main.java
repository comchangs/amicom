...
public class main extends Activity {
    ...
    public void HttpPostData() {
        try {
             ...
             //   URL 설정하고 접속하기
             //--------------------------
             URL url = new URL("http://haksa.ajou.ac.kr/uni/uni/cour/tlsn/findCourPersonalTakingLessonAply.action");       // URL 설정
             ...
             http.setRequestProperty("Referer", "http://haksa.ajou.ac.kr/aimsDdx1.5.2.swf");
             http.setRequestProperty("x-flash-version", "10,3,181,26");
             http.setRequestProperty("content-type", "text/xml;charset=utf-8");
             http.setRequestProperty("Accept-Encoding", "gzip, deflate");
             http.setRequestProperty("User-Agent", "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0; MASN)");
     		...
     		parameter = new String("<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
     				"<root>\n<params>" +
     				"<param id=\"strYy\" type=\"STRING\">2011</param>" +
     				"<param id=\"strShtmCd\" type=\"STRING\">U0002001</param>" +
     				"<param id=\"strStdNo\" type=\"STRING\">"+stdnum+"</param>" +
