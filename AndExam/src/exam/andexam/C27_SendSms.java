...
public class C27_SendSms extends Activity {
	TextView mNum;
	TextView mText;
	TextView mSent;
	TextView mDelivery;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.c27_sendsms);
		...
		public void onClick(View v) {
			...
			case R.id.sendsms:
				...
				PendingIntent SentIntent = PendingIntent.getBroadcast(
						C27_SendSms.this, 0, new Intent(ACTION_SENT), 0);
				PendingIntent DeliveryIntent = PendingIntent.getBroadcast(
						C27_SendSms.this, 0, new Intent(ACTION_DELIVERY), 0);
