...
public class C22_NewsService extends Service {
	boolean mQuit;
	...
	class NewsThread extends Thread {
		...
		public NewsThread(C22_NewsService parent, Handler handler) {
			mParent = parent;
			mHandler = handler;
		}
		public void run() {
	...
	Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			if (msg.what == 0) {
				...
				Toast.makeText(C22_NewsService.this, news, 0).show();
			}
		}
	};
}