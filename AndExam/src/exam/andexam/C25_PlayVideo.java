...
public class C25_PlayVideo extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.c25_playvideo);
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			Toast.makeText(C25_PlayVideo.this, "error : " + e.getMessage(), 
