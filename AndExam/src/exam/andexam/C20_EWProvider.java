...
public class C20_EWProvider extends ContentProvider {
	static final Uri CONTENT_URI = Uri.parse("content://exam.andexam.EnglishWord/word");
	...
	static {
		...
		Matcher.addURI("exam.andexam.EnglishWord", "word", ALLWORD);
		Matcher.addURI("exam.andexam.EnglishWord", "word/*", ONEWORD);
	}
