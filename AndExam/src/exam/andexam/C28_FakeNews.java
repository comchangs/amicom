...
public class C28_FakeNews extends AppWidgetProvider {
	...
	static void UpdateNews(Context context, AppWidgetManager appWidgetManager, 
		...
		Intent intent = new Intent(context, C28_FakeNewsDetail.class);
		...
		Intent intent2 = new Intent(context, C28_FakeNewsConfig.class);
		...
		Intent intent3 = new Intent(context, C28_FakeNews.class);
